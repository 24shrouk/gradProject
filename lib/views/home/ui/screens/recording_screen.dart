...
class _RecordingScreenState extends State<RecordingScreen>
  ...
  Future<void> fetchTopics() async {
    ...
    try {
      final response = await Dio().get('http://10.0.2.2:8000/detect_topics/');
  ...
  Future<void> fetchTasks() async {
    ...
    try {
      final response = await Dio().get('http://10.0.2.2:8000/extract_tasks/');
      if (response.statusCode == 200) {
        final data = response.data;
  ...
  Future<void> fetchEnhancedText() async {
    ...
    final dio = Dio();
    const url =
        'http://10.0.2.2:8000/enhance/'; // غيّري IP لو بتجربي على جهاز حقيقي
  ...
  Future<void> fetchSummary() async {
    ...
    final dio = Dio();
    const url =
        'http://10.0.2.2:8000/summarize/'; // غيّري IP لو بتجربي على موبايل حقيقي
